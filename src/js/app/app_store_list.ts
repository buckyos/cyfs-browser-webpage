      ...
      for (let index = 0; index < g_installedAppList.length; index++) {
        ...
        if(app_status == cyfs.AppLocalStatusCode.InstallFailed || app_status == cyfs.AppLocalStatusCode.UninstallFailed){
          ...
          installedHtml += `<li>
                              ...
                              <div class="float_l app_installed_info_box">
                                  ${((app_status == cyfs.AppLocalStatusCode.NoService || app_status == cyfs.AppLocalStatusCode.Running) && app.webdir)?`<a class="app_installed_webdir" target="_blank"  href="cyfs://a/${app.app.calculate_id().to_base_58()}/index.html"></a>`:''}
