export const en =  {
    ...
    "Guide":{
        ...
        "CreateIdentityInfo": "Digital Identity(DID) is like a  passport for you to travel the Web3 world. With one DID, you can access all DEC Apps on CYFS network. To set up a Digital Identity, you need to download and install <a class='color287 text_decoration_none' href='https://www.cyfs.com/download_en.html#chat' target='_blank'> Cyber Chat</a> first. There are some guides on Cyber Chat to lead you create your own Digital Identity, and also some token as rewards.",
