export const en =  {
    ...
    "ScanCodeActivate": "Please scan the QR code with CyberChat <br/>to activate",
    ...
    "Guide":{
        ...
        "CreateIdentityInfo": "Digital Identity(<span class='color287  did_click'>DID<i class='info_floating_window'>Decentralized identity (DID)  , also referred to as self-sovereign identity, is an open-standards based identity framework that uses digital identifiers and verifiable credentials that are self-owned, independent, and enable trusted data exchange.<div class='close_window_i'></div></i></span>) is like a  passport for you to travel the Web3 world. With one DID, you can access all DEC Apps(Date Exchange Contract) on CYFS network. To set up a Digital Identity, you need to download and install <a class='color287 text_decoration_none' href='https://www.cyfs.com/download_en.html#chat' target='_blank'> Cyber Chat</a> first. There are some guides on Cyber Chat to lead you create your own Digital Identity, and also some token as rewards.",
        "AccessOOD": "Access your first OOD",
        "AccessOODInfo": "<span class='color287 text_decoration_none ood_click'>OOD<i class='ood_floating_window'>OOD (Owner Online Device) is more like your smartphone, which is a personal server device based on the CYFS protocol. You could use the OOD for decentralized, secure data storage and install DEC (Data Exchange Contract) App. The data is encrypted and stored in the OOD to guarantee your data privacy and security.<div class='close_window_i'></div></i></span> is the most critical design of CYFS, since all DEC App services will be running on the OOD and all the data you have or you get will be stored on it. We believe that OOD is the basis of decentralization, and all the OOD consists of a huge decentralized network.",
        "AccessOODInfoTwo": "To setup an OOD, you can simply follow the Cyber Chat guides after creating DID There are also some token rewards for you.",
        ...
        "AlmostThere": "Almost there !",
        "AlmostThereInfo": "Please use CyberChat to scan the QR code above for activating CYFS Browser.",
        "BACK": "BACK",
        ...
        "TryAnySite": "Try any Web3 site in read-only mode",
